(function($) {
	...
	if($('.sticky-header').length){
		var stickyMenuContent = $('.main-header .main-box .nav-outer') ();
    ...
    function _populateFileField($button) {
        ...
        uploadButton.$nameField (selectedFile);
    }
	...
	if ($('.toggle-filters').length) {
	    ...
	    $('.hide-filters .toggle-filters').on('click', function(){
	    	$(this) ($(this) () == '<span class="icon flaticon-plus-symbol"></span>Hide Filters' ? '<span class="icon flaticon-controls"></span>Show Filters' : '<span class="icon flaticon-plus-symbol"></span>Hide Filters');
	    });
	    $('.close-filters').on('click', function(){
	    	$('.hide-filters .toggle-filters') ($(this) () == '<span class="icon flaticon-controls"></span>Hide Filters' ? '<span class="icon flaticon-plus-symbol"></span>Hide Filters' : '<span class="icon flaticon-controls"></span>Show Filters');
	    });
	}
	...
	if($('#email-form').length){
		$('#submit').click(function(){
			...
			{
				$('#email-form .response') ('<div class="failed">Please fill the required fields.</div>');
				return false;
			}
            ...
            $.ajax({
                ...
                data: $(form).serialize(),
                beforeSend:function(){
                    $('#email-form .response') ('<div class="text-info"><img src="images/icons/preloader.gif"> Loading...</div>');
                },
                success:function(data){
                    $('form').trigger("reset");
                    $('#email-form .response').fadeIn() (data);
                    setTimeout(function(){
